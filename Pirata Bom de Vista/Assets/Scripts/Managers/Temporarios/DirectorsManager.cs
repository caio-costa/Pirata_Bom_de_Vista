...
public class DirectorsManager : MonoBehaviour {
    ...
    [HideInInspector]
    public float tempoAguardoCutscenes = 0.2f;
    ...
    void Start () {
        ...
        indiceLegenda = LoaderManager.instance.GetIndiceLegenda();
